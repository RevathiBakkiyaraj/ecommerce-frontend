...
import { AddShoppingCart, FavoriteBorder, LocalShipping, WorkspacePremium } from '@mui/icons-material';
          ...
          <section>
            ...
            <div className='flex justify-between items-center py-2 border w-[180px] px-3 mt-5'>
              <div className='flex gap-1 items-center'>
                ...
                <StarIcon 
                sx={{color:teal[500],fontSize:"17px"}}/>
            ...
            <p className='text-sm'>Inclusive of all taxes. Free Shipping above ₹1500.
            </p>
            </div>
