  ...
  return (
    ...
    <div className ='space-y-5 lg:space-y-10 relative pb-20'>
        ...
        <section className='lg:px-20 relative h-[200px] lg:h-[450px] object-cover'>
            <img className='w-full h-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRetwW9FN-UZtQpoy4y3So3y_Toy6UMBFINTTPG_vV6Iw&s=10" alt="Advertisement" />
            <div className="absolute top-1/2 right-4 lg:right-[15rem] transform -translate-y-1/2 font-semibold lg:text-4xl space-y-3">
            <h1>
                Sell your Product
            </h1>
            <p className='text-lg md:text-2xl'>With <span className='logo'>Rev Bazaar</span></p>
